          ...
          {side == "edit" ? (
            <section className="w-full flex-wrap flex mt-8 h-[447px] max-md:h-[330px] max-md:gap-4">
              <div className="w-[30%] max-md:w-full flex justify-center">
                <img
                  src={image}
                  alt=""
                  className="w-full h-full rounded-2xl object-cover max-md:w-[60%]"
                />
              </div>
              <div className="w-[70%] flex flex-wrap justify-center max-md:w-full max-md:gap-10">
                ...
                <div className="w-full pl-4 max-md:pl-8">
                  <div className="w-[190px] h-[54px] rounded-[64px] bg-[#3b71f7] flex justify-center items-center text-[white] font-semibold text-base cursor-pointer">
                    Save Changes
                  </div>
                </div>
              </div>
            ...
            <section className="w-full mt-8 flex flex-col gap-8">
              ...
              <div className="w-full mt-4 space-y-4">
                <InputContainer labelText="Current Password" type="Password" />
                <InputContainer labelText="New Password" type="Password" />
              </div>
