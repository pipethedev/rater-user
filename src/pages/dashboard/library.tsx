...
const Library = () => {
  ...
  const musics = [
    {
      songTitle: "Asiwaju",
      playTime: "Play Time — 2:45",
      rating: "Good",
    },
    {
      songTitle: "MadOverYou",
      playTime: "Play Time — 2:45",
      rating: "Good",
    },
    {
      ...
      <DashboardLayout>
        <div className="w-full">
          ...
          <div className="flex gap-2 items-center border-t-[1px] border-b-[1px] border-[#e0dcdc] py-4 w-full">
            ...
            <div className="text-[#3B71F7] font-semibold text-sm">Library</div>
          </div>
          {songs ? (
            <div>
              <div className="text-[20px] text-[black] font-semibold my-4">
                All Songs - {musics.length}
              </div>
                ...
                {musics.map((music) => {
                  return (
                    <div
                      ...
                      onClick={() => {
                        navigate(`/dashboard/${music.songTitle}`);
                      }}
                    >
                      {musicSvg()}
