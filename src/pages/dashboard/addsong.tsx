...
const addsong = () => {
  ...
  useEffect(() => {
    ...
    paymentReference && !paymentReference[paymentReference.length - 1].used
      ? (steps = 2)
      : (steps = 1);
  }, []);
  ...
  if (price) {
    // if (
    //   paymentReference &&
    //   !paymentReference[paymentReference.length - 1].used
    // ) {
    //   setsteps(2);
    //   console.log("FALSE");
    // }
                ...
                <>
                  <form action="">
                    ...
                    <button
                      ...
                      className="bg-[#3b71f7] rounded-[64px] w-full h-[56px] flex justify-center mt-8 items-center font-semibold text-[white] cursor-pointer"
                    >
                      Upload Song
                    </button>{" "}
                  </form>
